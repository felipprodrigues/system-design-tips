      ...
      <PageLayout>
        ...
        <div className="sd-intro">
          <p>
            ...
            <strong className="sd-strong">decompose a single, massive dataset</strong> into smaller, manageable chunks across multiple database nodes.
          </p>
          <p>
            Vertical scaling adds more power — CPU, RAM — to a single server. Horizontal scaling via sharding instead{" "}
            <strong className="sd-strong">distributes data across an entire cluster</strong>, theoretically overcoming the storage and throughput limits of one machine.
          </p>
        </div>
        ...
        <div className="sd-section">
          ...
          <div className="sd-prose">
            <p>
              ...
              <strong className="sd-strong">separate physical server</strong>. Unlike partitioning — often done on a single instance to improve local query performance — sharding explicitly addresses the scaling bottlenecks of one physical database server.
            </p>
            <p style={{ marginTop: 10 }}>
              The core of a sharded architecture is the{" "}
              <strong className="sd-strong">Shard Key</strong> — the column (or set of columns) used to determine which shard a row belongs to. Choosing this key is the most critical design decision.
            </p>
          </div>

          <div style={{ background: "rgba(74, 81, 112,0.07)", borderRadius: 0, padding: "14px 18px", fontSize: 13, lineHeight: 1.7 }}>
            A poor shard key choice leads to <strong className="sd-strong">&quot;hot shards&quot;</strong> — one server handling 90% of the traffic, defeating the purpose of the distribution.
          </div>
        </div>
        ...
        <div className="sd-section">
          ...
          <h2 className="sd-h2">
            <span style={{ display: "inline-block", fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", padding: "2px 9px", borderRadius: 4, background: "rgba(157, 176, 247,0.12)", color: "var(--sd-green)", marginRight: 10, verticalAlign: "middle" }}>
              Range
            </span>
            Range-Based Sharding
          </h2>
          ...
          <pre style={{ background: "var(--sd-bg)", border: "1px solid var(--sd-border)", borderRadius: 10, padding: "16px 18px", marginBottom: 16, overflowX: "auto", fontSize: 12.5, lineHeight: 1.9 }}>
            <code className="sd-strong">
              <span style={{ color: "var(--sd-green)" }}>Shard 1</span>: user_id <span className="sd-hl-amber">1</span> to <span className="sd-hl-amber">1,000,000</span>{"\n"}
              <span style={{ color: "var(--sd-green)" }}>Shard 2</span>: user_id <span className="sd-hl-amber">1,000,001</span> to <span className="sd-hl-amber">2,000,000</span>
            </code>
          </pre>

          <div style={{ background: "rgba(74, 81, 112,0.07)", borderRadius: 0, padding: "14px 18px", fontSize: 13, lineHeight: 1.7 }}>
            This is simple to implement but leads to <strong className="sd-strong">uneven distribution</strong>. If your application creates many new users, the shard holding the highest range experiences significantly more write pressure than the others.
          </div>
        </div>
        ...
        <div className="sd-section">
          ...
          <pre style={{ background: "var(--sd-bg)", border: "1px solid var(--sd-border)", borderRadius: 10, padding: "16px 18px", marginBottom: 16, overflowX: "auto", fontSize: 12.5, lineHeight: 1.7 }}>
            <code className="sd-strong">
              Shard ID = <span className="sd-hl">hash</span>(user_id) <span className="sd-hl-accent">%</span> total_shards
            </code>
          </pre>
          ...
          <div className="sd-figure">
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ background: "rgba(127, 147, 242,0.12)", border: "1px solid var(--sd-teal)", borderRadius: 10, padding: "12px 28px", fontSize: 13, fontWeight: 700, color: "var(--sd-teal)", textAlign: "center" }}>
                Calculate Hash
          ...
          <div style={{ background: "rgba(127, 147, 242,0.07)", borderRadius: 0, padding: "14px 18px", fontSize: 13, lineHeight: 1.7 }}>
            ...
            <strong className="sd-strong">broadcast the query to every shard and aggregate the results</strong>.
          </div>
        </div>
        ...
        <div className="sd-section">
          ...
          <h2 className="sd-h2">Range vs. Hash at a Glance</h2>
        ...
        <div className="sd-section">
          ...
          <h2 className="sd-h2">Partitioning Strategies Within a Single Node</h2>
          ...
          <div className="sd-prose">
            <p>
              ...
              <strong className="sd-strong">without the complexity of a distributed network</strong>.
            </p>
          </div>
        ...
        <div className="sd-section">
          ...
          <h2 className="sd-h2">Implementing a Shard Map</h2>

          <div className="sd-prose">
            <p>
              To route requests, the application or a middleware layer needs a{" "}
              <strong className="sd-strong">&quot;Shard Map&quot;</strong> — a look-up table that maintains the association between the shard key range and the physical connection string of the database instance.
            </p>
          </div>
          ...
          <pre style={{ background: "var(--sd-bg)", border: "1px solid var(--sd-border)", borderRadius: 10, padding: "16px 18px", marginBottom: 0, overflowX: "auto", fontSize: 12.5, lineHeight: 1.7 }}>
            <code className="sd-strong">
              <span className="sd-hl-muted">{"# Simplified Shard Router"}</span>{"\n"}
              <span className="sd-hl-accent">class</span> <span className="sd-hl">ShardRouter</span>:{"\n"}
              {"    "}<span className="sd-hl-accent">def</span> <span className="sd-hl">__init__</span>(<span className="sd-hl-amber">self</span>):{"\n"}
              {"        "}<span className="sd-hl-muted">{"# Maps shard IDs to database connection strings"}</span>{"\n"}
              {"        "}<span className="sd-hl-amber">self</span>.shard_map = {"{\n"}
              {"            "}<span className="sd-hl-amber">0</span>: <span className="sd-hl-amber">&quot;db-node-0.internal:5432&quot;</span>,{"\n"}
              {"            "}<span className="sd-hl-amber">1</span>: <span className="sd-hl-amber">&quot;db-node-1.internal:5432&quot;</span>,{"\n"}
              {"            "}<span className="sd-hl-amber">2</span>: <span className="sd-hl-amber">&quot;db-node-2.internal:5432&quot;</span>{"\n"}
              {"        }\n\n"}
              {"    "}<span className="sd-hl-accent">def</span> <span className="sd-hl">get_connection</span>(<span className="sd-hl-amber">self</span>, user_id):{"\n"}
              {"        "}shard_id = <span className="sd-hl">hash</span>(user_id) <span className="sd-hl-accent">%</span> <span className="sd-hl-amber">3</span>{"\n"}
              {"        "}<span className="sd-hl-accent">return</span> <span className="sd-hl-amber">self</span>.shard_map[shard_id]{"\n\n"}
              <span className="sd-hl-muted">{"# Usage"}</span>{"\n"}
              router = ShardRouter(){"\n"}
              conn = router.get_connection(user_id=<span className="sd-hl-amber">89234</span>){"\n"}
              <span className="sd-hl-muted">{"# Output: \"db-node-2.internal:5432\""}</span>
            </code>
          </pre>
        </div>
        ...
        <div className="sd-section">
          ...
          <h2 className="sd-h2">Trade-offs and Operational Complexity</h2>
          ...
          <div className="sd-stack">
            {tradeoffs.map((item) => (
              <div key={item.title} style={{ background: "rgba(106, 118, 163,0.07)", borderRadius: 0, padding: "12px 14px" }}>
                <div style={{ fontSize: 12.5, fontWeight: 700, color: "var(--sd-text)", marginBottom: 5 }}>{item.title}</div>
                <p style={{ fontSize: 12.5, color: "var(--sd-muted)", lineHeight: 1.65 }}>{item.body}</p>
              </div>
            ))}
        ...
        <div className="sd-section">
          ...
          <h2 className="sd-h2">Data Placement, Not Data Consistency</h2>
          ...
          <div className="sd-callout sd-callout-green">
            ...
            <strong className="sd-strong">data co-location</strong> to minimize the need for cross-shard operations. Partitioning and sharding are purely about data placement; next, we&rsquo;ll explore how to keep that data{" "}
            <strong className="sd-strong">consistent</strong> across those nodes.
          </div>
        </div>
      ...
      <SidePanel open={panelOpen} onClose={() => setPanelOpen(false)} title="Going further">
        <PanelSection title="How do you rebalance a hash-sharded cluster without reshuffling everything?">
          ...
          <div className="sd-panel-note">
            <strong className="sd-hl">Plain modulo hashing and consistent hashing solve the same routing problem</strong> — the difference only shows up the moment the shard count changes.
          </div>
        </PanelSection>
        ...
        <PanelSection title="What is two-phase commit, and why do cross-shard transactions need it?">
          <p className="sd-text-sm">
            ...
            <strong className="sd-strong">two different shards</strong>, there's no single engine watching both — something else has to coordinate.
          </p>
          {[
            {
          ...
          <div className="sd-panel-note">
            <strong className="sd-hl">Two-phase commit buys atomicity across shards at the cost of availability during the protocol.</strong> It's the CAP theorem's trade-off showing up again, one layer down.
          </div>
        </PanelSection>
        ...
        <PanelSection title="How do you keep JOINs cheap once data is sharded?">
          <p className="sd-text-sm">
            ...
            <strong className="sd-strong">application-level fan-out</strong> — unless you design around it.
          </p>
          {[
            {
          ...
          <div className="sd-panel-note">
            <strong className="sd-hl">Co-location isn&rsquo;t a database feature — it&rsquo;s a modeling decision.</strong> You choose the shard key so the joins you actually run stay on one machine.
          </div>
        </PanelSection>
        ...
        <PanelSection title="Range vs. hash sharding — how do you actually decide?">
          <p className="sd-text-sm">
            ...
            <strong className="sd-strong">which queries you run most often</strong>.
          </p>
          {[
            {
          ...
          <div className="sd-panel-note">
            <strong className="sd-hl">Start from your access patterns, not the algorithm.</strong> The shard key is a bet on what you'll query — get it wrong and you're re-sharding in production.
          </div>
        </PanelSection>
      </SidePanel>
